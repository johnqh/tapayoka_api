...
import vendorInstallationsLegacy from "./vendor/installations-legacy.ts";
...
import vendorInstallations from "./vendor/vendorInstallations.ts";
import vendorInstallationControls from "./vendor/installationControls.ts";
...
vendorEntityRoutes.route("/installation-controls", vendorInstallationControls);
vendorEntityRoutes.route("/equipments", vendorEquipments);
vendorEntityRoutes.route("/devices", vendorDevices);
vendorEntityRoutes.route("/services", vendorInstallationsLegacy);
